...
export default function Members() {
    ...
    const [openNextOfKinDrawer, setOpenNextOfKinDrawer] = useState(false);
    ...
    //  Search filter
    const filteredMembers = members.filter(({ Customer }) => {
    ...
    const handlePrintPDF = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute("download", "Members_List.pdf"); // filename
            ...
            <div className="flex justify-start mb-6">
                <div className="relative w-full max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-11 pr-4 py-3 rounded-full border border-gray-300 bg-white text-sm shadow-sm placeholder-gray-400 focus:outline-none
            ...
            <div className="bg-gray-200 p-4 rounded-sm">
                ...
                {loading ? (
                    ...
                    filteredMembers.map((m) => (
                        <div
                            key={m.Id}
                            className="bg-white shadow-sm rounded-lg p-4 mb-4 transition"
                        >
                            {/* Row */}
                            <div className="grid grid-cols-14 gap-4 items-center">
                                ...
                                {/* <div className="col-span-2">
                                    <Button
                                        ...
                                        onClick={() => {
                                            setSelectedCustomerId(m.Id);   // 👈 parent/customer id
                                            setOpenNextOfKinDrawer(true);  // 👈 open drawer
                                        }}
                                    >
                                        Add Next of Kin
                                    </Button>
