...
export default function FixedAssetsSetup() {
  ...
  const handleMoreInfo = (asset) => {
    Swal.fire({
      title: `<strong>Asset Details</strong>`,
      html: `
        <div style="text-align:left; padding: 10px;">
          <p style="margin: 8px 0;"><b>No:</b> ${asset.No}</p>
          <p style="margin: 8px 0;"><b>Serial Number:</b> ${asset.SerialNo}</p>
          <p style="margin: 8px 0;"><b>Asset Name:</b> ${asset.AssetName}</p>
          <p style="margin: 8px 0;"><b>Created Date:</b> ${new Date(asset.CreatedDate).toLocaleDateString()}</p>
          <p style="margin: 8px 0;"><b>SubClass:</b> ${asset.FASubClassDescription}</p>
          <p style="margin: 8px 0;"><b>Location:</b> ${asset.LocationDescription}</p>
          <p style="margin: 8px 0;"><b>Responsible Employee:</b> ${asset.ResponsibleEmployee || "N/A"}</p>
          <p style="margin: 8px 0;"><b>Book Value:</b> ${asset.BookValue || "N/A"}</p>
        </div>
      `,
