      ...
      >
        ...
        <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="mt-6 h-48 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={spendData}>
                      ...
                      <Area type="monotone" dataKey="value" stroke="#059669" fill="url(#spend)" strokeWidth={2} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
            {/* Vendor Performance */}
            <Card className="shadow-sm bg-emerald-600">
              <CardHeader>
              ...
              <CardContent className="space-y-3 bg-white rounded-2xl p-4">
                {vendors.map((v) => (
                  <div key={v.name}>
            ...
            <Card className="shadow-sm">
              ...
              <CardContent>
                ...
                <div className="mt-4 h-3 rounded-full bg-muted">
                  <div className="h-3 rounded-full bg-emerald-600" style={{ width: "68%" }} />
                </div>
              </CardContent>
            </Card>
          </div>
